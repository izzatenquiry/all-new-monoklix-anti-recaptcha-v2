...
const ConsoleLogSidebar: React.FC<ConsoleLogSidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-4 bottom-auto z-[70]
      ...
      >
        ...
        <div className="flex flex-col h-full p-4 sm:p-6">
            ...
            <div 
                ref={logContainerRef} 
                className="flex-1 overflow-y-auto custom-scrollbar bg-neutral-50 dark:bg-black/40 rounded-2xl border-[0.5px] border-neutral-200/80 dark:border-white/5 p-3 sm:p-4 space-y-2"
            >
                {logs.length === 0 ? (
